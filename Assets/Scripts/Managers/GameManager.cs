...
public class GameManager : MonoBehaviour
{
    ...
    {
        OnGoldChange.Invoke();   
        SfxManager.instance.PlaySound(SoundType.THEME, 1, true, Bus.MUSIC);
    }
    ...
    public void OnWaveFinished(int currentWave) {
        print("Current wave: " + currentWave.ToString());
        print(SaveDataManager.instance);
        SaveDataManager.instance.SetLevelData(LevelSelection.levelSelected, currentWave);
    }
